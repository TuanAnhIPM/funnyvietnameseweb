...
export const outcomes = [
  {
    ...
    body: "Master all 6 Vietnamese tones through real mouth, lip, and tongue control — not just recognizing them, producing them, so you're understood the first time, not the third.",
  },
  {
